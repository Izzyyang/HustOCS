...
<body>
	...
	<header id="header">
		<hgroup>
			<h1 class="site_title"><a href="index.html">华中大公开课教师系统</a></h1>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="index.html">工具</a> <div class="breadcrumb_divider"></div> <a class="current" id="currentpage">开始新课</a></article>
		</div>
	...
	<aside id="sidebar" class="column" style="min-height:660px; max-height:800px;">
		<h3>工具</h3>
		<ul class="toggle">
			<li class="icn_new_article" id="addnewCourse"><a href="index.html">开设新课程</a></li>
			<li class="icn_edit_article" id="personInform"><a href="personalinfo.html">个人资料</a></li>
			<li class="icn_categories" id="personSafe"><a href='securityinfo.html'">账号安全</a></li>
		...
		<ul class="toggle" id="courses">
			<li class="icn_folder">
			    <a>数据库技术与应用</a>
			    <ul class="tog">
				     <li><a href="updateCourse.html" style="background:url(images/icn_edit.png) no-repeat scroll left center rgba(0, 0, 0, 0);" id="updatec"> 修改课程信息</a>
					 </li>
					 <li><a href="lessoninfo.html" id="upload">上传课件</a></li>
				</ul>
			</li>
	     ...
	     <div id="tab1" class="tab_content">
			...
			<tbody> 
				<tr> 
    				...
    				<td><input type="image" src="images/icn_edit.png" title="Edit" id="cedit" onClick="ShowDiv('MyDiv','fade')" ><input type="image" src="images/icn_trash.png" title="Trash"></td> 
				</tr> 
				<tr> 
   					<td><input type="checkbox" name="subcheck"></td> 
    				<td>第一课时 数据库简介</td> 
